...
public class ZeroScoreTest {
	...
	@Test
	public void zeroScoreExecuteSuccessfully() throws IOException {
		...
		List<Play> plays = parser.parse("src\\test\\resources\\positive\\zeros.txt");
		...
		boolean actual = FileUtils.contentEquals(new File("src\\test\\resources\\test_output.txt"),
				new File("src\\test\\resources\\filesToCompare\\correct_zero_score_output.txt"));
		assertTrue(actual);
	}
}
