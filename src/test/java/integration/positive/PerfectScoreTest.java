...
public class PerfectScoreTest {
	...
	@Test
	public void perfectScoreExecuteSuccessfully() throws IOException {
		...
		List<Play> plays = parser.parse("src\\test\\resources\\positive\\perfect.txt");
		...
		boolean actual = FileUtils.contentEquals(new File("src\\test\\resources\\test_output.txt"),
				new File("src\\test\\resources\\filesToCompare\\correct_perfect_score_output.txt"));
		assertTrue(actual);
	}
}
